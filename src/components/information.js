        ...
        <div className="section-info">
          ...
          <ul className="section-info-points">
            ...
            <li>
              ...
              redesigning application using Bootstrap, CSS3, and HTML5, leading
              to a decrease of underutilized hours.
            </li>
          </ul>
          ...
          <ul className="section-info-points">
            <li>
              Facilitated software testing to provide feedback to developers as
              part of the software development cycle.
            </li>
            <li>
              Expanded internal QA libraries with Python scripts that identified
              potential hazards to software deployment.
            </li>
            <li>
              Streamlined the product-to-market pipeline by reproducing bugs and
              implementing preventative measures via Python scripts.
            </li>
          </ul>
        </div>
      </div>
